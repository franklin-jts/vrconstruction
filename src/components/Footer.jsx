      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-5 space-y-2.5 text-sm text-white/80">
              <a href="tel:+917802808080" className="flex items-center gap-2.5 hover:text-brand">
                <Phone className="h-4 w-4 text-brand" /> +91 7802-80-80-80
              </a>
              <a href="mailto:info@vrconstructions.in" className="flex items-center gap-2.5 hover:text-brand">
                <Mail className="h-4 w-4 text-brand" /> info@vrconstructions.in
              </a>
            ...
            <div className="mt-5 flex items-center gap-3">
              {[Facebook, Instagram, Youtube, Linkedin].map((Icon, i) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-white/80 transition hover:border-brand hover:bg-brand hover:text-white"
                >
        ...
        <div className="mt-10 border-t border-white/10 pt-6">
          ...
          <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2">
            {areas.map((a) => (
              <span key={a} className="text-xs text-white/60">
                {a}
              </span>
            ))}
          </div>
